...
SAVE_DIR = PROJECT_ROOT / "data" / "outputs" / "another_data_japanese" / "doc_count_score_threshold_feature_counts"
...
TEXT_COLUMN = "text"
LABEL_COLUMN = "label"
ENGINE_MODULE_NAME = "active.another_data.doc_count_score_threshold_feature_count"
