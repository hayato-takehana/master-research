...
FEATURE_COUNT_CANDIDATES = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
...
BASE_FEATURE_CONDITIONS = (
    ...
    (RELATIVE_TERM_FREQUENCY_MODE, ROW_L2_FEATURE_MODE),
    (LOG_TERM_FREQUENCY_MODE, COLUMN_MIN_MAX_FEATURE_MODE),
    (LOG_TERM_FREQUENCY_MODE, ROW_L2_FEATURE_MODE),
    (TF_S_MODE, FULL_VOCAB_ROW_L2_FEATURE_MODE),
    (LOG_TF_S_MODE, FULL_VOCAB_ROW_L2_FEATURE_MODE),
)
...
FEATURE_CONDITIONS = (
    ...
    *(
        (
            selection_mode,
            FILTERED_FEATURE_MODE_BY_BASE[feature_mode],
        )
        for selection_mode, feature_mode in BASE_FEATURE_CONDITIONS
    ),
)
